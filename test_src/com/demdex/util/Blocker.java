package com.demdex.util;

import java.util.concurrent.CountDownLatch;
import java.util.concurrent.atomic.AtomicBoolean;

/**
 * A utility class used for performing concurrency testing. 
 * 
...
public class Blocker {
	...
	public void setBlockingEnabled(boolean blockingEnabled) {
		this.blockingEnabled.set(blockingEnabled);
	}

	private CountDownLatch latch = new CountDownLatch(1);
	private AtomicBoolean isBlocking = new AtomicBoolean();
	private AtomicBoolean blockingEnabled = new AtomicBoolean(true);
}
